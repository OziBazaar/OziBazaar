...
namespace OziBazaar.NotificationScheduler
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("OziBazaar.NotificationScheduler is running");
        ...
        public override bool OnStart()
        {
            ...
            Trace.TraceInformation("OziBazaar.NotificationScheduler has been started");
        ...
        {
            Trace.TraceInformation("OziBazaar.NotificationScheduler is stopping");
            ...
            Trace.TraceInformation("OziBazaar.NotificationScheduler has stopped");
        }
