...
namespace OziBazaar.NotificationSender
{
    public class WorkerRole : RoleEntryPoint
    {
       ...
       { 
        ...
        {
            Trace.TraceInformation("OziBazaar.NotificationSender is stopping");
            ...
            Trace.TraceInformation("OziBazaar.NotificationSender has stopped");
        }
